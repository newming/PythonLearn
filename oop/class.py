...
print(xiaoming.name)
# {'name': 'newming', 'age': 33} __dict__ 查找对象实例上的属性变量，字典
print(xiaoming.__dict__)

print(Person.name)
print(
	Person.__dict__)  # {'__module__': '__main__', 'name': '我是原型上的属性 name', 'age': 0, '__init__': <function Person.__init__ at 0x10d6a3c80>, 'print_file': <function Person.print_file at 0x10d6a3bf8>, '__dict__': <attribute '__dict__' of 'Person' objects>, '__weakref__': <attribute '__weakref__' of 'Person' objects>, '__doc__': None}
